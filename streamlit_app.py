...
# Removed load_dotenv() and its import since we're using st.secrets
...
with st.container():
    ...
    bucket_name = st.secrets['aws']['bucket']  # Updated to use st.secrets
    ...
    if selected_task_id:
        ...
        # Initialize S3 client with credentials from st.secrets
